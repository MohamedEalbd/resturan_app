...
class ManageScreens extends StatelessWidget {
              ...
              child: Container(
                ...
                child: Stack(
                  children: [
                    GridView.builder(
                        shrinkWrap: true,
                        itemCount: FoodManagementCubit.instance.options.length,
                        ...
                        itemBuilder: (_, index) {
                          return GestureDetector(
                            onTap: () {
                              FoodManagementCubit.instance.changePage(index);
                             switchForNameRoute(index);
                            },
                            child: Column(
